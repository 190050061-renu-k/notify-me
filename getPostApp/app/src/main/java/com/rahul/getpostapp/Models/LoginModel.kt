...
class LoginModel(username:String, email:String, password:String,is_student:Boolean, is_instructor:Boolean,is_ta:Boolean, registration_token:String?) {
    val username:String
    private val email:String
    private val password:String
    private val is_student:Boolean
    private val is_instructor:Boolean
    private val is_ta:Boolean
